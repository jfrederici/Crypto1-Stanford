...
****************************************************************************************************************************************************************
    ...
    CBC Ciphertext    : 3d7290238c29d7ef909145333023dcaf4717ca288797497ac60e4cb8e26598d05f9fb506e00785fa246eef2e75e5fc1e
    Expected Plaintext: Basic CBC mode encryption needs padding.
    ...
    Expected Plaintext: Our implementation uses rand. IV
    ...
    Expected Plaintext: CTR mode lets you build a stream cipher from a block cipher.

    CTR Key           : 36f18357be4dbd77f050515c73fcf9f2
    CTR nonce_value 2 : fb73fcf54aacf42a
    CTR Ciphertext  2 : 80023b4137f310e7f3934b1c909024fd375891b0d4e005dc7f8e3de97523
    Expected Plaintext: Always avoid the two time pad!

****************************************************************************************************************************************************************
    Goal: A quick little script to verify proper encryption of messages encrypted uing encrypt_AES.py by trying to decrypt them again.
